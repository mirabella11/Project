...
public class ReportDBAdapter {
    ...
    public static final String ROW_ID = "idreport";
    public static final String Type_Test = "type";
     ...
     */
    public ReportDBAdapter(Context ctx) {
        this.miraCtx = ctx;
    }
     ...
     */
 /*   public long createReport(String name, String age){
        ContentValues initialValues = new ContentValues();
        initialValues.put(Report_NAME, name);
...
*/
 ...
 /*   public Cursor getAllReport() {
        ...
        return this.miraDb.query(DATABASE_TABLE, new String[] { ROW_ID,
               Report_NAME,AGE}, null, null, null, null, null);
    }
*/
    /**
 ...
 /*   public Cursor getReport(long rowId) throws SQLException {
        ...
        this.miraDb.query(true, DATABASE_TABLE, new String[] { ROW_ID, Report_NAME,
     ...
     */
 /*   public boolean updatReport(long rowId, String name,
    		String age){
        ContentValues args = new ContentValues();
        args.put(Report_NAME, name);
        args.put(AGE,age);
