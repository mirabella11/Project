...
public class MainLesson extends Activity implements OnClickListener {
	...
	private Word data;
	 ...
	 public void onCreate(Bundle savedInstanceState) {
	      ...
	      next.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view1) {
            	prev.setEnabled(true);
            	if (GlobalData.getInstance().position+1==GlobalData.getInstance().max_number[0]){
	 ...
	 public void playSound( ){
	   ...
	   public void ListAlfabet(){
		    alfabetDialog = new Dialog(MainLesson.this);
